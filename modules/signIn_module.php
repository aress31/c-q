...
<section class = "container">
	<section class = "signIn">
		...
		<form id = "signIn" method="POST" action="../treatments/authentification.php">
			...
			<label for password><a href = "../pages/forgotPassword.php" id = "link"> Forgot Password ? </a></label>
		...
		<br>
		<p> Don't have an account ? <a href = "../pages/forgot_password.php" id = "link"> Sign Up now </a> </p>
	</section>
